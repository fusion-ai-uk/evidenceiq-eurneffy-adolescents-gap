...
// Little glowing icon to mark ASH‑specific tiles
const Glow = () => <Sparkles className="h-4 w-4 text-amber-400 drop-shadow-[0_0_8px_rgba(251,191,36,0.75)]" />
...
export const weekSixTakeaways: ExecTakeaway[] = [
  {
    ...
    icons: [Glow, Activity, TrendingUp],
  ...
  },
  {
    ...
    icons: [Glow, MessageSquare, TrendingUp],
